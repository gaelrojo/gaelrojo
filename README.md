...
**Software Engineering Student · Android Developer · Founder @ Polaris Dev**

[![Location](https://img.shields.io/badge/📍_México-Pachuca%2FQuerétaro-0d1117?style=flat-square&labelColor=161b22&color=30363d)](#)
[![University](https://img.shields.io/badge/🎓_UPP-Ing._en_Software-0d1117?style=flat-square&labelColor=161b22&color=30363d)](#)
[![Company](https://img.shields.io/badge/🚀_Polaris_Dev-Fundador-0d1117?style=flat-square&labelColor=161b22&color=58a6ff)](#)
...
Bienvenido a mi perfil. Soy un estudiante apasionado de Ingeniería en Software en la **Universidad Politécnica de Pachuca** y fundador de **Polaris Dev**. Me mueve la idea de construir software que resuelva problemas reales y genere impacto en las personas — no solo código que funcione, sino productos que transformen negocios y vidas.
 
**🚀 Expertise**
 
- **Mobile:** Android nativo con Kotlin & Jetpack Compose, arquitectura MVVM, Material Design 3
- **Full Stack:** React + TypeScript + Vite en frontend, NestJS / Laravel en backend, Supabase / MongoDB / MySQL en datos
- **Cloud & DevOps:** Despliegues en AWS EC2 con PM2 + Nginx, Vercel, autenticación con Clerk, pagos con Stripe
- **Soft Skills:** Comunicación clara, liderazgo de proyectos, trabajo en equipo y mentalidad emprendedora
  
**💡 Interests**
 
- Construir productos digitales que resuelvan problemas reales en el mercado mexicano
- Arquitecturas de software escalables — SOA, microservicios, patrones de diseño
- Inteligencia Artificial aplicada: sistemas de recomendación, filtrado colaborativo, redes neuronales
- El lado humano del desarrollo: UX, diseño minimalista y experiencias que sorprendan
  
**☕ Beyond Code**
 
- Trabajo mejor en cafeterías — el ambiente correcto desbloquea la concentración
- Me interesa el diseño visual: ilustración técnica, minimalismo y estética mecha/ghost
- Leer sobre negocios, startups y estrategia de producto
- Explorar cómo la tecnología puede empoderar a las PYMEs en México
  
**🌱 Future Goals**
 
Mi meta es consolidar **Polaris Dev** como la empresa de software de referencia para negocios en México — desde una clínica médica hasta una cadena de restaurantes. A largo plazo, quiero construir productos propios que escalen más allá de los servicios y lleguen a miles de usuarios.
...
<p align="center">
  ...
  <a href="https://github.com/TU_USUARIO/edusync">
  ...
  <a href="https://github.com/TU_USUARIO/polaris-dev">
...
<p align="right">
  <a href="https://github.com/TU_USUARIO?tab=repositories">
    <img alt="All Repos" src="https://img.shields.io/badge/All%20Projects%20→-0d1117?style=flat-square&labelColor=161b22&color=30363d">
  </a>
</p>
...
<div align="center">
  <sub>⭐ from <a href="https://github.com/gaelrojo">Gael · México 🇲🇽</a></sub>
</div>
